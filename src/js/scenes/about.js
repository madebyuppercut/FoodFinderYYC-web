      ...
      <div className="about">
        <div className="g-r">
          <div className="g-c-s-12-12 g-c-m-8-12 p-tb-2 p-lr-4">
            ...
            <p className="tag">
              <span className="strong">Donate:</span> <a href:"https://www.canadahelps.org/en/dn/m/36061/donation"> Please help Brown Bagging for Calgary's Kids feed youth this summer.</a>
            </p>
          </div>
        </div>
      </div>
